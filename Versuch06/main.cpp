 ...
 * Hier wurde der Container vector eingebunden und der Umfang des Programmes damit unheimlich reduziert, was es effizienter macht.
 *
 *
 */
int main()
            	...
            	std::cin.ignore(10, '\n');
            		...
            		else
            		{
            			for (it = studentenListe.begin() ; it != studentenListe.end() ; it ++)
            			{
            				...
            				{
            					std::cout<<"Folgender Student wurde geloescht : " << std::endl;
            					it->ausgabe();
            					studentenListe.erase(it);
            				}
            			}
